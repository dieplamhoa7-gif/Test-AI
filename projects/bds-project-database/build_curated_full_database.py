...
fields=['curated_id','master_id','merged_from_ids','project_name','mention_count','first_report_date','latest_report_date','source_files','senders','latitude','longitude','coordinates','coordinate_quality','coordinate_anomaly_note','map_urls','location','province_city','district_area','land_area_main','land_area_main_raw','other_area_mentions','project_type','product_structure','scenario_data','land_type','planning_doc_status','planning_summary','max_floors_clean','far_clean','density_clean','population_clean','legal_summary','legal_status','gpm_status','lur_status','approval_status','asking_land_price','selling_price','land_cost','total_investment_clean','revenue_clean','profit_clean','irr_clean','npv_clean','payback_clean','financial_raw_mentions','financial_line_items','financial_unclassified_items','risks','next_actions','attachments','data_completeness_score','score_total','score_grade','score_location','score_data','score_planning','score_legal','score_financial','score_risk_penalty','score_notes','source_excerpt']
out=[]
for r in rows:
