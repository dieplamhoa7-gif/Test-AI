...
for r in rows:
    ...
    out.append(row)
out.sort(key=lambda r:(r['has_coordinates']!='yes',-(int(r.get('data_completeness_score') or 0)),r['project_name']))
