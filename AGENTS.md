...
- For long Telegram/OpenClaw work where context gets slow/confused, use `CURRENT_CONTEXT.md` as the active handoff. Keep it tiny: current goal, repo/folder, files, done, next, risks. Before switching/resetting sessions or pausing work, update it. In a fresh session, read it first instead of relying on long chat history.
