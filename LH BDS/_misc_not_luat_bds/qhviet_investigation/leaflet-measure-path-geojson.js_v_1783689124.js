!(function() {
    ...
    L.GeoJSON.include({
        showMeasurements: function(options) {
            ...
            // duyệt tất cả các layer con trong geojson
            this.eachLayer(function(layer) {
                if (layer instanceof L.Polyline || layer instanceof L.Circle) {
                    if (typeof layer.showMeasurements === 'function') {
                        layer.showMeasurements(this._measurementOptions);
                    }
                }
            }, this);
        ...
        hideMeasurements: function() {
            ...
            this.eachLayer(function(layer) {
                if ((layer instanceof L.Polyline || layer instanceof L.Circle) && 
                    typeof layer.hideMeasurements === 'function') {
        ...
        updateMeasurements: function() {
            ...
            this.eachLayer(function(layer) {
                if ((layer instanceof L.Polyline || layer instanceof L.Circle) && 
                    typeof layer.updateMeasurements === 'function') {
