...
from app.auto_chart_api import router as auto_chart_router
...
app.include_router(auto_chart_router)
APP_ASSET_VERSION = "2026-05-28-auto-chart-v1"
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",
        ...
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "https://lhinvestment.web.app",
        "https://lhinvestment.firebaseapp.com",
    ],
