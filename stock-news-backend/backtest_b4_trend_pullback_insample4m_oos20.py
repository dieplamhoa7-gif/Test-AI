...
OUT = Path('data/b4_trend_pullback_insample4m_oos20_backtest.json')
EXCLUDE = {'VIC', 'VHM'}
HORIZON = 42
...
def main():
    ...
    payload = {
        ...
        'name': 'B4 Trend Pullback insample4m oos20',
        ...
        'exit': {'targetPct': 6, 'takeProfitAtTargetPct': 50, 'trailingAfterTarget': 'max(entry+0.5%, peak-3%)', 'stopPct': 6},
        'insample4m': insample,
        'oos20': oos20,
    }
