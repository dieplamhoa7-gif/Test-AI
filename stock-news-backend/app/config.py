...
class Config:
    ...
    claude_model: str = os.getenv("CLAUDE_MODEL", "APIFREE")
    openai_key: str = os.getenv("OPENAI_API_KEY", "")
    chatgpt_model: str = os.getenv("OPENAI_MODEL", os.getenv("CHATGPT_MODEL", "APIFREE"))
    xai_key: str = os.getenv("XAI_API_KEY", "")
    xai_model: str = os.getenv("XAI_MODEL", "APIFREE")
