...
async def model3_latest(ticker: str):
    """Return latest persisted Model3 job/report for the stock-report page.

    The public page calls this on load. If missing, users can see stale UI even
    after fresh market data exists.
    """
