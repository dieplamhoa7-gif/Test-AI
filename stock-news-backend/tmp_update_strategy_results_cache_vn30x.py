...
src=Path('data/three_strategies_vn30x_cache_signals.json')
...
payload={'updatedAt':d.get('createdAt'),'note':'Current strategy signal cache refreshed from VN30 excluding VIC/VHM cache scan. Source: data/three_strategies_vn30x_cache_signals.json. Web reads output only.','strategies':[]}
